          ...
          children: [
            Container(
              child: defaultButton(
                  ...
                  function: () {
                    AdminCubit.get(context).PostDriverInQueue(
                        driver_code: AdminCubit.get(context)
                            .DriversOnline[index]['driverCode']);
                  },
                  text: 'The Turn',
                  isUberCase: false,
                  radius: 15),
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Row(
                    ...
                    children: [
                      Text(
                        ' ${AdminCubit.get(context).DriversOnline[index]['user']['name']} ',
                        maxLines: 1,
                      ...
                      Text(
                        'Car Id: ${AdminCubit.get(context).DriversOnline[index]['car']['carPlateNum']} ',
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                        style: TextStyle(
                          fontSize: 14.0,
